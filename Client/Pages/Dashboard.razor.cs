...
public partial class Dashboard
{
                ...
                [
                    new XAxis
                    {
                        ...
                        [
                            new XAxisPlotBands
                            {
                                From = 10.5, To = 12.5, Color = "rgba(255, 75, 66, 0.07)", Label = new XAxisPlotBandsLabel { Text = "Forecast" }
                            }
                        ]
                    }
                ],
    ...
    {
        decimal[] revenue = [..periods.Select(p => p.Performance.Revenue).ToArray()];

        var a = revenues.Take(periods.Length - 1);
        var b = periods.Last() with { Performance = periods.Last().Performance}
