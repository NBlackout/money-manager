...
public record TransactionBuilder(Guid Id, Guid AccountId, decimal Amount, string Label)
{
    public static TransactionBuilder For(Guid id) =>
        new(id, Guid.Parse("D5611488-65FE-469E-BA46-32D4E0730C08"), 1234.56m, "Label");
