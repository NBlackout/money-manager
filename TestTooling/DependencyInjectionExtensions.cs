...
{
    public static TImplementation Resolve<TService, TImplementation>(this IHost host) where TService : class where TImplementation : class, TService =>
    ...
    public static TImplementation Resolve<TContract, TImplementation>(this IServiceScope scope) where TContract : notnull where TImplementation : TContract =>
        scope.ServiceProvider.Resolve<TContract, TImplementation>();

    private static TContract Resolve<TContract>(this IServiceProvider serviceProvider) where TContract : notnull =>
