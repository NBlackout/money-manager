...
public class DateRangeProviderTests : InfraTest<IDateRangeProvider, DateRangeProvider>
{
    ...
    public async Task Gives_rolling_twelve_months()
    {
        ...
        await this.Verify(
            new DateRange(DateOnly.Parse("2024-02-01"), DateOnly.Parse("2024-02-29")),
            new DateRange(DateOnly.Parse("2024-03-01"), DateOnly.Parse("2024-03-31")),
            new DateRange(DateOnly.Parse("2024-04-01"), DateOnly.Parse("2024-04-30")),
            new DateRange(DateOnly.Parse("2024-05-01"), DateOnly.Parse("2024-05-31")),
            ...
            new DateRange(DateOnly.Parse("2024-10-01"), DateOnly.Parse("2024-10-31")),
            new DateRange(DateOnly.Parse("2024-11-01"), DateOnly.Parse("2024-11-30")),
            new DateRange(DateOnly.Parse("2024-12-01"), DateOnly.Parse("2024-12-31")),
            new DateRange(DateOnly.Parse("2025-01-01"), DateOnly.Parse("2025-01-31"))
        );
    }

    private async Task Verify(params DateRange[] expected)
    {
        DateRange[] actual = await this.Sut.RollingTwelveMonths();
